...
func main() {
	// Example transfer to write an ACH TRC file to debit an external institutions account
	...
	bh.CompanyEntryDescription = "ACH TRC"                               // will be on receiving accounts statement
