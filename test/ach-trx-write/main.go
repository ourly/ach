...
func main() {
	// Example transfer to write an ACH TRX file to send/credit a external institutions account
	...
	bh.CompanyEntryDescription = "ACH TRX"                               // will be on receiving accounts statement
	...
	entry.TransactionCode = ach.CheckingDebit // Code 27: Debit checking account
