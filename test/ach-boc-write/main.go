...
func main() {
	// Example transfer to write an ACH BOC file to debit an external institutions account
	...
	bh.CompanyEntryDescription = "ACH BOC"                               // will be on receiving accounts statement
